...
if (!text) return conn.reply(m.chat, `Polar necesita un link para comenzar a descargar.\n𝙀𝙟𝙚𝙢𝙥𝙡𝙤\n*${usedPrefix + command} https://vm.tiktok.com/ZMFsFMWgh/*`, fkontak,  m)
...
await conn.reply(m.chat, `⌛ _𝘾𝙖𝙧𝙜𝙖𝙙𝙤..._\n▰▰▰▱▱▱▱▱▱\nPolar está procesando su video. 🔰`, fkontak,  m)    
